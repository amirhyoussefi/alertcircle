...
function GetAccessToken($FQDN,$api_key,$secret_key,$scope,$authCode){
  ...
  */
  if($responseCode==200)
    {
      print("inside200");
      print("accessTok_response=$accessTok_response");
  ...
  header("location:loc.php");//redirect to the index page.
  exit;
...
if ($_SESSION["tl1_deviceLocation"]) {
  ...
  if($accessToken == null || $accessToken == '') {
    ...
    if ($authCode == null || $authCode == "") {
      ...
      print("after setting session variable".$_SESSION["tl1_deviceLocation_access_token"]);
    }
  }
 }
